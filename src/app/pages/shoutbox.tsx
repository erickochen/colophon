      ...
      <Card className="relative overflow-hidden py-0">
        <CardContent className="grid p-0">
          ...
          <div className="border-t bg-muted/30 px-4 py-3 sm:px-6">
            ...
            <div className="flex h-11 items-center gap-1 rounded-lg border border-input-line bg-background pl-1 pr-1.5 transition-[color,box-shadow] focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring">
