...
function DialogTrigger({
  ...
  return <DialogPrimitive.Trigger data-slot="dialog-trigger" {...withAsChild({ asChild, ...props })} />
}
...
function DialogClose({
  ...
  return <DialogPrimitive.Close data-slot="dialog-close" {...withAsChild({ asChild, ...props })} />
}
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border bg-background p-6 shadow-lg duration-200 outline-none data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 sm:max-w-lg",
          className
        )}
        {...props}
      >
