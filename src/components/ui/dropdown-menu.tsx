    ...
    <DropdownMenuPrimitive.Portal container={getPortalContainer()}>
      ...
      >
        <DropdownMenuPrimitive.Popup
          ...
          className={cn(
            // Keyboard focus lands on the items, so the popup itself needs no ring.
            "z-50 max-h-(--available-height) min-w-[8rem] origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-md border bg-popover p-1 text-popover-foreground shadow-md outline-none data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
            className
          )}
          {...props}
        />
...
function DropdownMenuLabel({
  ...
  // Plain div: Base UI's GroupLabel requires a Group parent, Radix labels
  // were free-standing and call sites rely on that.
  return (
    <div
    ...
    <DropdownMenuPrimitive.Portal container={getPortalContainer()}>
      <DropdownMenuPrimitive.Positioner className="z-50">
        <DropdownMenuPrimitive.Popup
          ...
          className={cn(
            "z-50 min-w-[8rem] origin-(--transform-origin) overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-lg data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
            className
          )}
          {...props}
        />
